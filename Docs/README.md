# CodexLight Documentation

[项目主页](../README.md) | [Project Home](../README.en.md)

本目录保存面向用户和维护者的补充文档。

This directory contains supplemental documentation for users and maintainers.
...
| [获取 Codex 运行状态](获取Codex运行状态.md) | Codex 日志来源、状态判定、调试和排障说明 |
